...
export interface ApiBlogPageBlogPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Slug: Attribute.UID<'api::blog-page.blog-page', 'Title'> &
      Attribute.Required;
    Info: Attribute.Component<'layout.page-info', true>;
    excluded_tags: Attribute.Relation<
...
export interface ApiCoursePageCoursePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Slug: Attribute.UID<'api::course-page.course-page', 'Title'> &
      Attribute.Required;
    Info: Attribute.Component<'layout.page-info'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSeoConfigSeoConfig extends Schema.SingleType {
  ...
  attributes: {
    DefaultSeo: Attribute.Component<'seo.seo-information', true>;
